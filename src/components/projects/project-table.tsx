        ...
        {projects.map((project, index) => (
          <TableRow key={index}>
            ...
            <TableCell className="sm:grid sm:gap-2 sm:grid-cols-4">
                {project.stack.map((stackItem: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | PromiseLikeOfReactNode | null | undefined, stackIndex: Key | null | undefined) => (
